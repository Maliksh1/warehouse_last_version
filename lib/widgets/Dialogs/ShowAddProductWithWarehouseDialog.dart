          ...
          onPressed: () {
            if (formKey.currentState!.validate()) {
              final newProduct = Product(
                // The ID should be generated by the backend, so we can pass a temporary value or 0.
                id: 0,
                name: nameController.text,
                description: skuController.text,
                // Assuming importCycle and typeId are integers.
                // We use tryParse to avoid errors if the text is not a valid number.
                importCycle: int.tryParse(categoryIdController.text) ?? 0,
                quantity: 0, // Default value, can be updated as needed.
                typeId: int.tryParse(categoryIdController.text) ?? 0,
                unit:
                    'unit', // Default value, should be taken from a form field if available.
                actualPiecePrice:
